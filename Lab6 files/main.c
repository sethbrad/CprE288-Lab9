...
//                read = read /16;
//
//                //multiply the voltage value by the digital value divided by its max digital value
...
//        double numerator = 3.3 * read;
//        double voltage = numerator / 4095;
//        double calculation = 2754649 * pow(read,-1.57); //used power function in excel
//
//        lcd_printf("%.3f", calculation);
//
//        char format[] = "";
//        sprintf(format, "%d,      %.3f,     %.1f", read,voltage,calculation);
//
//        uart_sendStr(format);
//        uart_sendChar('\r');
//        uart_sendChar('\n');
